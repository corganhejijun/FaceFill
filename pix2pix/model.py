...
class pix2pix(object):
    def __init__(self, sess, image_size=128, batch_size=1, sample_size=1, output_size=128, load_size=144,
        ...
        Args:
            ...
            output_size: (optional) The resolution in pixels of the images. [128]
    ...
    def sample_model(self, sample_dir, epoch, idx):
        ...
        samples, d_loss, g_loss = self.sess.run(
            [self.fake_B_sample_128, self.d_loss_128, self.g_loss_128], feed_dict={self.real_data: sample_images}
        )
    ...
    def train(self, args):
        ...
        for epoch in xrange(args.epoch):
            ...
            for idx in xrange(0, batch_idxs):
                ...
                counter += 1
                print("Epoch: [%2d] [%4d/%4d] time: %4.4f, d_loss: [%.8f, %.8f], g_loss: [%.8f, %.8f]" \
                        % (epoch, idx, batch_idxs, time.time() - start_time, errD_64, errD_128, errG_64, errG_128))
