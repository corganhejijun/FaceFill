...
parser.add_argument('--load_size', dest='load_size', type=int, default=144, help='scale images to this size')
...
parser.add_argument('--test_size', dest='test_size', type=int, default=128, help='input image size on test')
